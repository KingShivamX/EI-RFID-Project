...
void setup() {
  ...
  if (v == 0x00 || v == 0xFF) {
    Serial.println(F("ERROR: RFID reader not responding. Check connections."));
  } else {
    Serial.println(F("SUCCESS: RFID reader connected and ready."));
  }
}
...
void loop() {
  ...
  // Send just the card ID without any prefix
